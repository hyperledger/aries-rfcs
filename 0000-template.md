...
*Implementation Notes* should include a link to test results if your RFC is protocol-related and if it has tests in the [test suite repo](https://github.com/hyperledger/aries-protocol-test-suite), it MUST list the test suite in the protocol RFC's [Implementations section](../0000-template.md#implementations). This MUST be the case if the status of the RFC is ACCEPTED.
