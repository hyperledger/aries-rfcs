...
__retired__ with a forwarding hyperlink, not replaced. A PROPOSED or DEMONSTRATED RFC may be retired
if the consensus of the community is that the RFC is not worth pursuing.
