...
```json=
{
    "@type": "https://didcomm.org/present-proof/%ver/device-binding-challenge",
...
```json=
{
    ...
    "formats" : [
        ...
        {
            "attach_id" : "device-binding-challenge-0",
            "format" : "dif/device-binding@v0.1",
        }
    ],
    "request_presentations~attach": [
        {
...
```json=
{
    "@type": "https://didcomm.org/present-proof/%ver/device-binding-response",
    "@id": "<uuid-challenge-response>",
    "proofs" : [
        {
...
```json=
{
    ...
    "formats" : [
        ...
        {
            "attach_id" : "device-binding-response-0",
            "format" : "dif/device-binding@v0.1",
        }
    ],
    "presentations~attach": [
...
To fully support the [present-proof-v2](https://github.com/hyperledger/aries-rfcs/tree/main/features/0454-present-proof-v2) protocol the format of the `device-binding-challenge` must be defined within the `formats` array of the `request-presentation` and the `presentation` message.



| Presentation Format | Format Value | Link to Attachment Format | Comment |
| --- | --- | --- | --- |
| Device Binding Challenge | `dif/device-binding@v0.1` | [device-binding-challenge](#device-binding-challenge) | Used to proof control of a hardware bound key |
