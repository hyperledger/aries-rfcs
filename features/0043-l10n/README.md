...
[RFC 0192: Coin Flip Protocol](../0192-coin-flip/README.md) | Uses this mechanism to localize the `comment` field, when human iteraction around coin tosses is a a goal.
